...
```
go get github.com/aceeric/imgpull@v1.15.0
```

## The Examples

To run each example, first `cd` into the example directory, then `go mod tidy && go run main.go`.
...
| `readtar` | Reads an image tarball. |
